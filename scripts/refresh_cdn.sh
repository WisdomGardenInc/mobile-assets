...
declare -a tasks=(
  ...
  "https://purge.jsdelivr.net/npm/@wisdomgarden/mobile-assets@latest/app-legal/policy-jump.html"
  "https://purge.jsdelivr.net/npm/@wisdomgarden/mobile-assets@latest/app-legal/marked-4.0.1.min.js"
  "https://purge.jsdelivr.net/npm/@wisdomgarden/mobile-assets@latest/app-legal/policy-common.js"
  "https://purge.jsdelivr.net/npm/@wisdomgarden/mobile-assets@latest/app-legal/policy-common.css"
  "https://purge.jsdelivr.net/npm/@wisdomgarden/mobile-assets@latest/app-legal/privacy-policy.html"
  "https://purge.jsdelivr.net/npm/@wisdomgarden/mobile-assets@latest/app-legal/privacy-policy-info.json"
  "https://purge.jsdelivr.net/npm/@wisdomgarden/mobile-assets@latest/app-legal/privacy-policy-zh-CN.md"
  "https://purge.jsdelivr.net/npm/@wisdomgarden/mobile-assets@latest/app-legal/privacy-policy-en.md"
  "https://purge.jsdelivr.net/npm/@wisdomgarden/mobile-assets@latest/app-legal/privacy-policy-zh-TW.md"
  "https://purge.jsdelivr.net/npm/@wisdomgarden/mobile-assets@latest/app-legal/user-agreement.html"
  "https://purge.jsdelivr.net/npm/@wisdomgarden/mobile-assets@latest/app-legal/user-agreement-info.json"
  "https://purge.jsdelivr.net/npm/@wisdomgarden/mobile-assets@latest/app-legal/user-agreement-zh-CN.md"
  "https://purge.jsdelivr.net/npm/@wisdomgarden/mobile-assets@latest/app-legal/user-agreement-zh-TW.md"
  "https://purge.jsdelivr.net/npm/@wisdomgarden/mobile-assets@latest/app-legal/user-agreement-en.md"
  "https://purge.jsdelivr.net/npm/@wisdomgarden/mobile-assets@latest/app-legal/children-privacy-policy.html"
  "https://purge.jsdelivr.net/npm/@wisdomgarden/mobile-assets@latest/app-legal/children-privacy-policy-info.json"
  "https://purge.jsdelivr.net/npm/@wisdomgarden/mobile-assets@latest/app-legal/children-privacy-policy-zh-CN.md"
  "https://purge.jsdelivr.net/npm/@wisdomgarden/mobile-assets@latest/app-legal/summary-privacy-policy.html"
  "https://purge.jsdelivr.net/npm/@wisdomgarden/mobile-assets@latest/app-legal/summary-privacy-policy-zh-CN.md"
  "https://purge.jsdelivr.net/npm/@wisdomgarden/mobile-assets@latest/app-legal/privacy_policy_google_play.html"
